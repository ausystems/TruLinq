...
export const TERMS = {
  ...
  sections: [
    ...
    { h: 'Honest use', short: 'No fakes, no forgeries, no spam, no scraping. Fraud means permanent removal.', body: 'No impersonation, forged documents, stolen identities, spam, harassment, or scraping the directory. Attempting to obtain a stamp fraudulently results in permanent removal.' },
    { h: 'Revocation', short: 'If the facts change or fraud is confirmed, the stamp can be suspended or revoked at any time.', body: 'We may suspend or revoke a stamp at any time if information becomes false, a business closes, documents are found to be invalid, or credible fraud reports are confirmed.' },
    { h: 'Fees', short: 'Review fees pay for a human review and are non-refundable once it starts. Plans renew yearly unless cancelled.', body: 'Paid verification fees cover human review and are non-refundable once a review has started. Plans renew annually unless cancelled before renewal.' },
    { h: 'Content you publish', short: 'You own your profile content. You let us show it in the directory and on your profile.', body: 'You keep ownership of your profile content and grant Trulinq a licence to display it in the directory and on your public profile.' },
    { h: 'Liability', short: 'Trulinq is provided as-is. We are not part of your deals and not liable for them.', body: 'Trulinq is provided as-is. We are not a party to deals between members and are not liable for losses arising from any business relationship formed through the platform.' },
    { h: 'Changes', short: 'We may update these terms and will announce material changes. Continued use means acceptance.', body: 'We may update these terms; material changes will be announced by email or in the app. Continued use means acceptance.' }
  ]
};
